<%@ page language="VB" autoeventwireup="false" inherits="MonitoringCenter_ViewWinServices, App_Web_zn3-f7gx" enableEventValidation="false" theme="App_Themes" maintainScrollPositionOnPostBack="true" %>
												...
												<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
													<TR>
														<TD><asp:button id="BtnGrdSearch" runat="server" Height="0" Width="0px"></asp:button><asp:imagebutton id="Imagebutton1" tabIndex="1" runat="server" Height="1px" Width="1px" ImageUrl="~/images/white.GIF"
																...
																name="ingShow">
															<asp:label id="lblTitleLabelWinSvcStatus" runat="server" BorderStyle="None" BorderWidth="2px"
																Font-Size="X-Small" Font-Names="Verdana" Font-Bold="True" ForeColor="Teal" Width="176px">Windows Service Status</asp:label></TD>
														<TD vAlign="bottom" align="center">&nbsp;&nbsp;&nbsp;&nbsp;<IMG class="PlusImageCSS" id="imgPause" title="Pause" onclick="SaveEdit('Pause');" alt="A"
																src="../Images/s2Add01.gif" border="0" name="tbrbtnNew"> <IMG title="Seperator" alt="R" src="../Images/00Seperator.gif" border="0" style="WIDTH: 7px; HEIGHT: 20px"
																height="20" width="7">&nbsp; <IMG class="PlusImageCSS" title="Refresh" onclick="SaveEdit('Refresh');" alt="E" src="../Images/S2edit01.gif"
																border="0" name="tbrbtnEdit" id="imgRefresh">&nbsp;&nbsp;<IMG class="PlusImageCSS" title="Search" onclick="SaveEdit('Search');" alt="S" src="../Images/s1search02.gif"
																border="0" name="tbrbtnSearch">&nbsp; <IMG class="PlusImageCSS" title="Start" onclick="SaveEdit('Start');" height="28" alt="R"
																src="../Images/reset_20.gif" width="39" border="0" name="tbrbtnReset" id="imgStart" style="WIDTH: 39px; HEIGHT: 28px">&nbsp;
															...
															<IMG title="Seperator" alt="R" src="../Images/00Seperator.gif" border="0">&nbsp;<IMG class="PlusImageCSS" title="Stop" onclick="SaveEdit('Stop');" alt="" src="../Images/s2close01.gif"
																border="0" name="tbrbtnClose" id="imgStop">
														</TD>
														<TD></TD>
														<td>&nbsp;
														</td>
															...
															<TBODY>
																...
																<TR>
																	<td><cc1:collapsiblepanel id="cpnlViewJobs" runat="server" Height="47px" Width="100%" BorderStyle="Solid"
																			BorderWidth="0px" Draggable="False" CollapseImage="../Images/ToggleUp.gif" ExpandImage="../Images/ToggleDown.gif"
																			Text="Windows Services" TitleBackColor="Transparent" TitleClickable="True" TitleForeColor="black"
																					...
																					<TR>
																						<TD vAlign="top" align="left"><!--  **********************************************************************-->
																							<asp:datagrid id="GrdAddSerach" runat="server" ForeColor="MidnightBlue" Font-Names="Verdana" BorderWidth="1px"
																								BorderStyle="None" BorderColor="Silver" DataKeyField="ServiceName" CssClass="grid" PageSize="50"
