<%@ page language="VB" autoeventwireup="false" inherits="MonitoringCenter_Alert, App_Web_zn3-f7gx" enableEventValidation="false" theme="App_Themes" maintainScrollPositionOnPostBack="true" %>
													...
													<TR>
														<TD><asp:button id="BtnGrdSearch" runat="server" Height="0" Width="0px"></asp:button><asp:imagebutton id="Imagebutton1" tabIndex="1" runat="server" Height="1px" Width="1px" ImageUrl="~/images/white.GIF"
															...
															<asp:label id="lblAB" runat="server" BorderStyle="None" BorderWidth="2px" Font-Size="X-Small"
																Font-Names="Verdana" Font-Bold="True" ForeColor="Teal">Alerts</asp:label></TD>
														<TD vAlign="bottom" align="center"><IMG title="Seperator" alt="R" src="../Images/00Seperator.gif" border="0">&nbsp;<IMG class="PlusImageCSS" id="Save" title="Save" onclick="SaveEdit('Save');" alt="" src="../Images/S2Save01.gif"
																border="0" name="tbrbtnSave">&nbsp;&nbsp;<IMG class="PlusImageCSS" title="Search" onclick="SaveEdit('Search');" alt="S" src="../Images/s1search02.gif"
																border="0" name="tbrbtnSearch">&nbsp;<IMG class="PlusImageCSS" title="Reset" onclick="SaveEdit('Reset');" alt="R" src="../Images/reset_20.gif"
																border="0" name="tbrbtnReset">&nbsp;<IMG class="PlusImageCSS" title="Delete" onclick="ConfirmDelete('Delete','Are you sure you want to Delete the selected record ?');"
															...
															<TBODY>
																...
																<TR>
																	<td><cc1:collapsiblepanel id="cpnlViewJobs" runat="server" Height="47px" Width="100%" BorderStyle="Solid"
																			...
																			Text="Alerts" TitleBackColor="Transparent" TitleClickable="True" TitleForeColor="black" PanelCSS="panel"
																			...
																			<DIV style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 400pt">
																				<TABLE id="Table1261" borderColor="activeborder" cellSpacing="0" cellPadding="0" width="100%"
																					...
																					<TR>
																						<TD vAlign="top" align="left"><!--  **********************************************************************-->
																							<asp:datagrid id="GrdAddSerach" runat="server" ForeColor="MidnightBlue" Font-Names="Verdana" BorderWidth="1px"
																								BorderStyle="None" BorderColor="Silver" DataKeyField="AlertID" CssClass="grid" PageSize="50"
																					...
																					<TR>
																						<TD>
																							<asp:DropDownList id="ddlAlertType_F" Width="101pt" Height="18px" Font-Names="Verdana" Font-Size="XX-Small"
																								CssClass="txtNoFocusFE" Runat="server"></asp:DropDownList>
																							<asp:TextBox id="txtAlertCode_F" Width="98pt" Height="18px" Font-Names="Verdana" Font-Size="XX-Small"
																								CssClass="txtNoFocusFE" Runat="server"></asp:TextBox>
																							<asp:TextBox id="txtAlertSubject_F" Width="148pt" Height="18px" Font-Names="Verdana" Font-Size="XX-Small"
																								CssClass="txtNoFocusFE" Runat="server"></asp:TextBox>
																							<asp:TextBox id="txtAlertDescription_F" Width="247pt" Height="18px" Font-Names="Verdana" Font-Size="XX-Small"
																								CssClass="txtNoFocusFE" Runat="server"></asp:TextBox></TD>
																					</TR>
																				</TABLE>
																			</DIV>
																		</cc1:collapsiblepanel></td>
