<%@ page language="VB" autoeventwireup="false" inherits="Reports_ReportsPages_KnowledgeDbRptDS, App_Web_vuff4xgi" maintainscrollpositiononpostback="true" enableEventValidation="false" theme="App_Themes" %>
...
<head id="Head1" runat="server">
    ...
    <link href="../../SupportCenter/calendar/popcalendar.css" rel="stylesheet" type="text/css" />
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr style="width: 100%">
                                    <td background="../../Images/top_nav_back.gif" height="47">
                                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                            <tr>
                                                <td style="width: 35%">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:Label ID="lblHead" runat="server" CssClass="TitleLabel" BorderStyle="None">Knowledge Database Report</asp:Label>
                                                </td>
                                                <td style="width: 50%; text-align: center;" nowrap="nowrap">
                                                    <center>
                                                        <asp:ImageButton ID="imgOK" runat="server" ImageUrl="../../Images/s1search02.gif"
                                                            ToolTip="Search"></asp:ImageButton>
                                                        <img src="../../Images/reset_20.gif" title="Refresh" alt="" style="cursor: hand;"
                                                            onclick="javascript:location.reload(true);" />&nbsp;<img src="../../Images/s2close01.gif"
                                    ...
                                    <td nowrap="nowrap" style="width: 10%" background="../../Images/top_nav_back.gif"
                                        height="47">
                                        <img class="PlusImageCSS" id="Help" title="Help" onclick="ShowHelp(955 ,'../../');"
                        ...
                        <td>
                            ...
                            <div style="overflow: auto; width: 100%">
                                    ...
                                    <tr>
                                        <td>
                                            <cc1:CollapsiblePanel ID="cpnlRS" runat="server" BorderWidth="0px" BorderStyle="Solid"
                                                ...
                                                ExpandImage="../../Images/ToggleDown.gif" Text="Knowledge Database Report" TitleBackColor="Transparent"
                                                ...
                                                <table id="Table3" style="border-color: #d7d7d7" cellspacing="4" cellpadding="1"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="ddlCompany" Width="128px" Font-Size="XX-Small" runat="server"
                                                                AutoPostBack="True" Height="18px">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label1" Font-Bold="True" Font-Names="Verdana" Font-Size="XX-Small"
                                                                runat="server">Sub Category</asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlProject" Width="120px" Font-Size="XX-Small" runat="server"
                                                                Height="18px">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label7" Font-Bold="True" Font-Names="Verdana" Font-Size="XX-Small"
                                                                runat="server">Knowledge DB</asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlCatCodeNew" Width="128px" Font-Size="XX-Small" runat="server"
                                                                Height="18px">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label3" Width="80px" Font-Bold="True" Font-Names="Verdana" Font-Size="XX-Small"
                                                                runat="server">Task Type</asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlTaskType" Width="120px" Font-Size="XX-Small" runat="server"
                                                                Height="18px">
                                                            </asp:DropDownList>
                                                        </td>
                                                        <td>
                                ...
                                <cc1:CollapsiblePanel ID="cpnlReport" runat="server" Width="100%" BorderStyle="Solid"
                                    ...
                                    TitleBackColor="Transparent" Text="Knowledge Database Report" ExpandImage="../../Images/ToggleDown.gif"
                                    CollapseImage="../../Images/ToggleUp.gif" Draggable="False" BorderColor="Indigo">
                                    <%-- <div style="overflow: auto; width: 99.7%; height: 447px">--%>
