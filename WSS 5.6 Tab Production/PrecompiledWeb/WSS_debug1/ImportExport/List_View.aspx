<%@ page language="VB" autoeventwireup="false" inherits="ImportExport_List_View, App_Web_rfdo_fu4" enableEventValidation="false" theme="App_Themes" maintainScrollPositionOnPostBack="true" %>
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr width="100%">
                                            ...
                                            <tr>
                                                <td valign="middle">
                                                    ...
                                                    <asp:Label ID="lblTitleLabelRoleSearch" runat="server" Width="136px" Height="12px"
                                                        BorderStyle="None" BorderWidth="2px" CssClass="TitleLabel"> LIST VIEW</asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img
                                    ...
                                    <td align="right" width="152" background="../Images/top_nav_back01.gif" height="67">
                                        <img class="PlusImageCSS" id="Help" title="Help" onclick="ShowHelp('966','../');"
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <cc1:CollapsiblePanel ID="cpnlGrdView" runat="server" Width="100%" Height="47px"
                                                                                        ...
                                                                                        PanelCSS="panel" TitleForeColor="black" TitleClickable="True" TitleBackColor="Transparent"
                                                                                        Text="List View" ExpandImage="../Images/ToggleDown.gif" CollapseImage="../Images/ToggleUp.gif"
                                                                                        Draggable="False">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td valign="top">
                                                                                                        ...
                                                                                                        <asp:DataGrid ID="GrdAddSerach" runat="server" BorderStyle="None" BorderWidth="1px"
                                                                                                            ...
                                                                                                            CellPadding="0" GridLines="Horizontal" HorizontalAlign="Left" PageSize="50" AutoGenerateColumns="False">
                                                                                                            ...
                                                                                                            <Columns>
                                                                                                                ...
                                                                                                                <asp:BoundColumn Visible="False" DataField="FM_NU9_File_ID_PK" HeaderText="FileID">
                                                                                                                </asp:BoundColumn>
                                                                                                            </Columns>
