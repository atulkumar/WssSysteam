<%@ page language="VB" autoeventwireup="false" inherits="Reports_SLAReport, App_Web_fzfabjfx" enableEventValidation="false" theme="App_Themes" maintainScrollPositionOnPostBack="true" %>
                                        ...
                                        <td background="../Images/top_nav_back.gif" height="47">
                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                <tr>
                                                    <td style="width: 20%">
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <asp:Label ID="lblHead" runat="server" CssClass="TitleLabel" BorderStyle="None">SLA Time Diff Report </asp:Label>
                                                    </td>
                                        ...
                                        <tr>
                                            <td>
                                                <cc1:CollapsiblePanel ID="cpnlRS" runat="server" Height="0px" Width="100%" BorderStyle="Solid"
                                                    ...
                                                    TitleBackColor="Transparent" Text="SLA Time Diff Report" ExpandImage="../Images/ToggleDown.gif"
