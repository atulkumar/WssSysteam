<%@ page language="VB" autoeventwireup="false" inherits="Reports_CallTaskAction, App_Web_wzhf50l2" maintainscrollpositiononpostback="true" enableEventValidation="false" theme="App_Themes" %>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblOwner" Font-Size="XX-Small" Font-Names="Verdana" Font-Bold="True"
                                                                Width="72px" Height="11px" runat="server">Task Owner</asp:Label>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblAssignedBy" runat="server" Font-Size="XX-Small" Font-Names="Verdana"
                                                                Font-Bold="True" Width="73px">Call Req. By</asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlAssignedBy" runat="server" Font-Size="XX-Small" Width="176px"
                                                                Height="18px">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
