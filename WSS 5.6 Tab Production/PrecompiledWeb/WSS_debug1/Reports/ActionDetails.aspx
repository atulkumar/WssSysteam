<%@ page language="VB" autoeventwireup="false" inherits="Reports_ActionDetails, App_Web_fzfabjfx" maintainscrollpositiononpostback="true" enableEventValidation="false" theme="App_Themes" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../images/js/core.js"></script>

    <script type="text/javascript" src="../images/js/events.js"></script>

    <script type="text/javascript" src="../images/js/css.js"></script>

    <script type="text/javascript" src="../images/js/coordinates.js"></script>
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr style="width: 100%">
                                            ...
                                            <tr>
                                                <td style="width: 20%">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblHead" runat="server" CssClass="TitleLabel"
                                                        BorderStyle="None">Action Detail </asp:Label>
                                                </td>
                                    ...
                                    <td nowrap="nowrap" style="width: 10%" background="../Images/top_nav_back.gif" height="47">
                                        <img class="PlusImageCSS" id="Help" title="Help" onclick="ShowHelp(1025,'../');"
                                    ...
                                    <tr>
                                        <td>
                                            <cc1:CollapsiblePanel ID="cpnlRS" runat="server" BorderWidth="0px" BorderStyle="Solid"
                                                ...
                                                ExpandImage="../Images/ToggleDown.gif" Text="Action Detail" TitleBackColor="Transparent"
                                    ...
                                    <tr>
                                        <td>
                                            <cc1:CollapsiblePanel ID="cpnlReport" runat="server" Width="100%" BorderStyle="Solid"
                                                ...
                                                TitleBackColor="Transparent" Text="Action Detail" ExpandImage="../Images/ToggleDown.gif"
                                                    ...
                                                    <tr>
                                                        <td valign="top" align="left" colspan="1" rowspan="1">
                                                            <CR:CrystalReportViewer ID="crvReport" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"
                                                                ...
                                                                PrintMode="ActiveX" ReuseParameterValuesOnRefresh="True" EnableTheming="true"
                                                                BestFitPage="false" Width="950px" Height="500px" />
                                                        </td>
                                                    </tr>
                                                </table>
                                                <%-- </div>--%>
                    ...
                    <ContentTemplate>
                        ...
                        <cc1:CollapsiblePanel ID="cpnlError" runat="server" BorderWidth="0px" BorderStyle="Solid"
                            ...
                            <asp:ListBox ID="lstError" runat="server" Width="697px" ForeColor="Red" Font-Names="Verdana"
                                Font-Size="XX-Small" BorderStyle="Groove" BorderWidth="0" Height="32px"></asp:ListBox>
                        </cc1:CollapsiblePanel>
