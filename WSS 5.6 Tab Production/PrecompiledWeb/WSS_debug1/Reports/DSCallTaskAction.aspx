<%@ page language="VB" autoeventwireup="false" inherits="Reports_ReportsPages_DSCallTaskAction, App_Web_fzfabjfx" enableEventValidation="false" theme="App_Themes" maintainScrollPositionOnPostBack="true" %>
...
function DDLChange(DDL,CMID,PID,CID,EID)
{
//alert(PID);
                                                ...
                                                <td background="../images/top_nav_back.gif" height="47">
                                                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                        <tr>
                                                            <td style="width: 30%">
                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                                <asp:Label ID="lblHead" runat="server" CssClass="TitleLabel" BorderStyle="None">Call Task Action </asp:Label>
                                                            </td>
                                                                    ...
                                                                    <td valign="top" align="left" style="width: 100%;">
                                                                        ...
                                                                        <table id="Table3" bordercolor="#d7d7d7" cellspacing="1" cellpadding="1" border="0">
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:DropDownList ID="ddlProject" Width="144px" Font-Size="XX-Small" runat="server"
                                                                                        Height="18px">
                                                                                    </asp:DropDownList>
                                                                                </td>
                                                                                <td>
                                                                                ...
                                                                                <td>
                                                                                    <asp:DropDownList ID="ddlEmployee" runat="server" Width="176px" Font-Size="XX-Small"
                                                                                        Height="18px">
                                                                                    </asp:DropDownList>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <asp:Label ID="lblAssignedBy" runat="server" Width="73px" Font-Bold="True" Font-Names="Verdana"
                                                                                        Font-Size="XX-Small">Call Req. By</asp:Label>
                                                                                </td>
                                                                                <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <cc1:CollapsiblePanel ID="cpnlReport" runat="server" BorderWidth="0px" BorderStyle="Solid"
                                                            ...
                                                            <table id="Table1" cellspacing="0" cellpadding="0" align="left" border="0" style="height: 100%;
                                                                ...
                                                                <tr>
                                                                    <td valign="top" align="left" colspan="1" rowspan="1">
                                                                        <CR:CrystalReportViewer ID="crvReport" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"
                                                                            ...
                                                                            PrintMode="ActiveX" ReuseParameterValuesOnRefresh="True" Height="490px" EnableTheming="true"
                                                                            BestFitPage="False" Width="860px" HasPageNavigationButtons="False" SeparatePages="False" />
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <%--</div>  --%>
