<%@ page language="VB" autoeventwireup="false" inherits="AdministrationCenter_Inventory_SubInventory, App_Web_oyn6drwr" enableEventValidation="false" theme="App_Themes" maintainScrollPositionOnPostBack="true" %>
	...
	<body bottommargin="0" topmargin="0" leftmargin="0">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" background="../../images/top_nav_back.gif"
				border="0">
				<TR>
					<TD><asp:label id="lblTitleLabelUserInfo" runat="server" Width="90px" CssClass="TitleLabel">&nbsp;Sub Items</asp:label></TD>
			...
			<TABLE id="Ta2ble1" cellSpacing="0" cellPadding="0" width="100%" background="../../images/top_nav_back.gif"
				...
				<TR>
					<TD vAlign="top" align="left" width="100%"><cc1:collapsiblepanel id="cpnlInventory" runat="server" Width="100%" BorderWidth="0px" BorderStyle="Solid"
							...
							ExpandImage="../../Images/ToggleDown1.gif" CollapseImage="../../Images/ToggleUp1.gif" Draggable="False" BorderColor="Indigo" state="expanded"></cc1:collapsiblepanel>
							...
							<TR>
								<TD>
									<asp:DataGrid id="grdInventory" runat="server" CssClass="Grid" Width="100%" BorderStyle="None"
										BorderWidth="1px" HorizontalAlign="Center" AutoGenerateColumns="False" CellPadding="1" DataKeyField="ItemID">
										...
										<Columns>
											<asp:BoundColumn DataField="InventoryIssueDetailID" HeaderText="Item&nbsp;ID" HeaderStyle-Width="50px"></asp:BoundColumn>
											<asp:BoundColumn DataField="ItemName" HeaderText="Item&nbsp;Name" HeaderStyle-Width="150px"></asp:BoundColumn>
											<asp:BoundColumn DataField="Category" HeaderText="Item&nbsp;Name" HeaderStyle-Width="150px"></asp:BoundColumn>
											<asp:BoundColumn DataField="SerialNo" HeaderText="R" HeaderStyle-Width="20px"></asp:BoundColumn>
											<asp:BoundColumn DataField="AllowedTill" HeaderText="ExReturnDate" HeaderStyle-Width="100px"></asp:BoundColumn>
											<asp:BoundColumn DataField="Status" HeaderText="Status" HeaderStyle-Width="50px"></asp:BoundColumn>
