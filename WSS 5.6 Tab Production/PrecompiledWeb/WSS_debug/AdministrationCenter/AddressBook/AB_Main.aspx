<%@ page validaterequest="false" language="vb" autoeventwireup="false" inherits="AB_Main, App_Web_p6k4cy-b" maintainscrollpositiononpostback="true" enableEventValidation="false" theme="App_Themes" %>
                                                                                ...
                                                                                <td bordercolor="#ffffff">
                                                                                    <font face="Verdana" size="1">
                                                                                        <asp:Label ID="lblID1" runat="server" Width="96px" ForeColor="Black" Font-Bold="True"
                                                                                            Font-Names="Verdana" Font-Size="XX-Small">ID #1</asp:Label></font><br>
                                                                                ...
                                                                                <td bordercolor="#ffffff">
                                                                                    <font face="Verdana" size="1">
                                                                                        <asp:Label ID="lblID2" runat="server" Width="96px" ForeColor="Black" Font-Bold="True"
                                                                                            Font-Names="Verdana" Font-Size="XX-Small">ID#2</asp:Label><br>
                                                                                    </font>
                                                                                ...
                                                                                <td bordercolor="#ffffff">
                                                                                    <font face="Verdana" size="1">
                                                                                        <asp:Label ID="lblReference1" runat="server" ForeColor="Black" Font-Bold="True" Font-Names="Verdana"
                                                                                            Font-Size="XX-Small">Reference1</asp:Label></font><br>
                                                                                ...
                                                                                <td bordercolor="#ffffff">
                                                                                    <font face="Verdana" size="1">
                                                                                        <asp:Label ID="lblReference2" runat="server" ForeColor="Black" Font-Bold="True" Font-Names="Verdana"
                                                                                            Font-Size="XX-Small">Reference2</asp:Label><br>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td bordercolor="#ffffff">
                                                                                    <font face="Verdana" size="1">
                                                                                        <asp:Label ID="lblHomePage1" runat="server" Width="96px" ForeColor="Black" Font-Bold="True"
                                                                                            Font-Names="Verdana" Font-Size="XX-Small">Home Page</asp:Label></font><br>
                                                                                ...
                                                                                <td bordercolor="#ffffff">
                                                                                    ...
                                                                                    <asp:Label ID="lblWebAddress" runat="server" Width="98px" ForeColor="Black" Font-Bold="True"
                                                                                        Font-Names="Verdana" Font-Size="XX-Small">Web Address</asp:Label><br>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="4">
                                                                            <asp:Label ID="Label12" runat="server" Width="96px" ForeColor="Black" Font-Bold="True"
                                                                                Font-Names="Verdana" Font-Size="XX-Small">Select Resume</asp:Label>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="4">
                                                                            <asp:Label ID="lblupload" runat="server" Width="112px"  ForeColor="Black"
                                                                                Font-Bold="True" Font-Names="Verdana" Font-Size="XX-Small">Uploaded Resume</asp:Label>
