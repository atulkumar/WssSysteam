<%@ page language="VB" autoeventwireup="false" inherits="Reports_SLA_7_Report, App_Web_sbqj3uth" enableEventValidation="false" theme="App_Themes" maintainScrollPositionOnPostBack="true" %>
                                                                    ...
                                                                    <MasterTableView>
                                                                        <Columns>
                                                                            <telerik:GridBoundColumn DataField="CM_NU9_Call_No_PK" DataType="System.String" HeaderText="Call No"
                                                                                ReadOnly="True" SortExpression="CM_NU9_Call_No_PK" UniqueName="CM_NU9_Call_No_PK" AllowFiltering="true"
                                                                            ...
                                                                            <telerik:GridBoundColumn DataField="Task Entered Date" DataType="System.DateTime" HeaderText="Task Entered Date"
                                                                                ReadOnly="True" SortExpression="Task Entered Date" UniqueName="Task Entered Date" AllowFiltering="true"
                                                                                CurrentFilterFunction="EqualTo">
                                                                            </telerik:GridBoundColumn>
