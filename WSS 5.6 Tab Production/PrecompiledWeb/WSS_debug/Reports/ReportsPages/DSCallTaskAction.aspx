<%@ page language="VB" autoeventwireup="false" inherits="Reports_ReportsPages_DSCallTaskAction, App_Web_njnctckq" maintainscrollpositiononpostback="true" enableEventValidation="false" theme="App_Themes" %>
                    ...
                    <tr>
                        <td>
                            ...
                            <div style="overflow: auto; width: 100%; height: 100%">
                                <table width="100%" style="border-color: activeBorder" border="0" cellpadding="0"
                                    cellspacing="0">
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <cc1:CollapsiblePanel ID="cpnlReport" runat="server" BorderStyle="Solid" BorderWidth="1px"
                                                ...
                                                PanelCSS="panel" Text="Call Summary" TitleBackColor="Transparent" TitleClickable="True"
