<%@ page language="VB" autoeventwireup="false" inherits="MobileBillsModule_ViewSummaryForAdmin, App_Web_m8wpfoiq" enableEventValidation="false" theme="App_Themes" maintainScrollPositionOnPostBack="true" %>
                                        ...
                                        <td background="../Images/top_nav_back.gif" height="47">
                                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                <tr>
                                                    <td style="width: 20%">
                                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                                        <asp:Label ID="lblHead" runat="server" CssClass="TitleLabel" BorderStyle="None">SLA 7 Report</asp:Label>
                                                    </td>
                                        ...
                                        <tr>
                                            <td>
                                                <cc1:CollapsiblePanel ID="cpnlRS" runat="server" Height="0px" Width="100%" BorderStyle="Solid"
                                                    ...
                                                    TitleBackColor="Transparent" Text="SLA 7 Report" ExpandImage="../Images/ToggleDown.gif"
                                                    ...
                                                    <table id="Table3" bordercolor="#d7d7d7" cellspacing="1" cellpadding="1" border="0">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ddlMonth" Font-Size="X-Small" Width="156px" Height="18px" runat="server">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    <table align="left">
                                                        <tr>
                                                            <td valign="top" align="left" colspan="1" rowspan="1">
                                                                <telerik:RadGrid ID="rgBillDetails" Visible="false" Width="1160" Height="400" runat="server"
                                                                    ...
                                                                    <MasterTableView>
                                                                        <Columns>
                                                                            <telerik:GridBoundColumn DataField="CM_NU9_Call_No_PK" DataType="System.String" HeaderText="Call No"
                                                                                ReadOnly="True" SortExpression="CM_NU9_Call_No_PK" UniqueName="CM_NU9_Call_No_PK"
                                                                                AllowFiltering="true" CurrentFilterFunction="EqualTo">
                                                                            ...
                                                                            <telerik:GridBoundColumn DataField="Registered Date" DataType="System.DateTime" HeaderText="Registered Date"
                                                                                ReadOnly="True" SortExpression="Registered Date" UniqueName="Registered Date"
                                                                                AllowFiltering="true" CurrentFilterFunction="EqualTo">
                                                                            </telerik:GridBoundColumn>
                                                                            <telerik:GridBoundColumn DataField="Task Entered Date" DataType="System.DateTime"
                                                                                HeaderText="Task Entered Date" ReadOnly="True" SortExpression="Task Entered Date"
                                                                                UniqueName="Task Entered Date" AllowFiltering="true" CurrentFilterFunction="EqualTo">
                                                                            </telerik:GridBoundColumn>
                                                                            <telerik:GridBoundColumn DataField="Difference In minutes" DataType="System.Int32"
                                                                            ...
                                                                            <telerik:GridBoundColumn DataField="Business Hours" DataType="System.String" HeaderText="Business Hours"
                                                                                ReadOnly="True" SortExpression="Business Hours" UniqueName="Business Hours" AllowFiltering="true"
