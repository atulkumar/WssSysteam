<%@ page language="VB" autoeventwireup="false" inherits="Escalation_Edit_EscalationSetup, App_Web_fffjuqa0" maintainscrollpositiononpostback="true" enableEventValidation="false" theme="App_Themes" %>
...
<head>
    <title>Edit Escalation Setup</title>
...
<body style="margin-left: 0px; margin-right: 0px; margin-top: 0px; background-color: #F5F5F5"
    ...
    <table id="Table1" style="border-color: activeborder" cellspacing="0" cellpadding="0"
        ...
        <tr>
            <td style="width:30%">
                &nbsp;&nbsp;
                <asp:Label ID="lblTitleLabelEditES" runat="server" BorderStyle="None" BorderWidth="2px"
                   CssClass="TitleLabel">Edit Escalation Setup</asp:Label>
            </td>
        ...
        <tr>
            <td valign="top" colspan="1">
                ...
                <cc1:CollapsiblePanel ID="cpnlCommSetupEdit" runat="server" Width="100%" BorderWidth="0px"
                    ...
                    TitleBackColor="Transparent" Text="Escalation Setup Edit" ExpandImage="../Images/ToggleDown.gif"
                        ...
                        <tr>
                            <td valign="top" align="left" width="63%">
                                <table width="520" bgcolor="#f5f5f5" border="0">
                                    <tr valign="top">
                                        <td style="height: 9px">
                                            <asp:CheckBox ID="chkIsMail" runat="server" Width="40px" Text="Mail" Font-Size="Smaller"
                                                Font-Bold="True"></asp:CheckBox>
                                            <asp:CheckBox ID="chkIsSMS" runat="server" Width="41px" Text="SMS" Font-Size="Smaller"
                                                Font-Bold="True"></asp:CheckBox>
                                        </td>
                                        <td style="height: 9px">
                                            <asp:Label ID="Label15" runat="server" CssClass="FieldLabel" Height="12px">Escalation Time</asp:Label>
                                            <asp:TextBox ID="txtTime" runat="server" CssClass="txtNoFocus" Width="127px" MaxLength="5"
                                                Height="12px"></asp:TextBox>
                                        </td>
                                        <td style="height: 9px">
                                            <asp:Label ID="Label16" runat="server" CssClass="FieldLabel" Height="12px">Mail Frequency</asp:Label>
                                            <asp:TextBox ID="txtFreq" runat="server" CssClass="txtNoFocus" Width="127px" MaxLength="5"
                                                Height="12px"></asp:TextBox>
                                        </td>
                                        <td style="height: 9px">
                                            &nbsp;
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <ION:Customcalendar ID="dtStartDate" runat="server" Height="16px" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <asp:DropDownList ID="ddEventName" runat="server" Width="129px" Height="20px" Font-Names="Verdana"
                                    ...
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <asp:DropDownList ID="ddEventUser" runat="server" Width="129px" Height="20px" Font-Names="Verdana"
                                                Font-Size="XX-Small">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                            <asp:Label ID="Label7" runat="server" CssClass="FieldLabel" Width="136px" Height="12px">On Event</asp:Label>
                                            <asp:DropDownList ID="ddEventFired" runat="server" Width="129px" Height="20px" Font-Names="Verdana"
                                                Font-Size="XX-Small">
                                        ...
                                        <td>
                                            ...
                                            <asp:DropDownList ID="ddCompany" runat="server" Width="129px" Height="20px" Font-Names="Verdana"
                                                Font-Size="XX-Small" AutoPostBack="True">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                            <asp:Label ID="Label3" runat="server" CssClass="FieldLabel" Width="72px">User Name</asp:Label><br>
                                            <asp:DropDownList ID="ddUserName" runat="server" Width="129" Height="20px" Font-Names="Verdana"
                                                Font-Size="XX-Small">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr valign="top">
                                        <td>
                                            ...
                                            <asp:DropDownList ID="ddRoleName" runat="server" Width="129" Height="20px" Font-Names="Verdana"
                                                Font-Size="XX-Small">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                            <asp:Label ID="Label9" runat="server" CssClass="FieldLabel" Width="42px" Height="12px">Priority</asp:Label>
                                            <asp:DropDownList ID="ddPriority" runat="server" Width="129" Height="20px" Font-Names="Verdana"
                                                Font-Size="XX-Small">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                            <asp:Label ID="Label6" runat="server" CssClass="FieldLabel" Width="72px" Height="12px">Call Type</asp:Label>
                                            <asp:DropDownList ID="ddCallType" runat="server" Width="129px" Height="20px" Font-Names="Verdana"
                                                Font-Size="XX-Small">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                            <asp:Label ID="Label10" runat="server" CssClass="FieldLabel" Width="72px">Call Status</asp:Label>
                                            <asp:DropDownList ID="ddCallStatus" runat="server" Width="129" Height="20px" Font-Names="Verdana"
                                                Font-Size="XX-Small">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            ...
                                            <asp:DropDownList ID="ddTaskType" runat="server" Width="129px" Height="20px" Font-Names="Verdana"
                                                Font-Size="XX-Small">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                            <asp:Label ID="Label11" runat="server" CssClass="FieldLabel" Width="68px" Height="14px">Task Status</asp:Label>
                                            <asp:DropDownList ID="ddTaskStatus" runat="server" Width="129" Height="20px" Font-Names="Verdana"
                                                Font-Size="XX-Small">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                            <asp:Label ID="Label8" runat="server" CssClass="FieldLabel" Width="72px" Height="12px">SubCategory</asp:Label>
                                            <asp:DropDownList ID="ddProject" runat="server" Width="129" Height="20px" Font-Names="Verdana"
                                                Font-Size="XX-Small">
                                                <asp:ListItem Value="0" Selected="True">Optional</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                            ...
                                            <asp:DropDownList ID="ddRecordStatus" runat="server" Width="129" Height="20px" Font-Names="Verdana"
                                                Font-Size="XX-Small">
