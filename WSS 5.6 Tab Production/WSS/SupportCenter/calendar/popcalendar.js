...
//  email :	sai_freelance@yahoo.com
	...
	var imgDir = "../../SupportCenter/calendar/"	// directory for images ... e.g. var imgDir="/img/"
    ...
    */
	...
	function popUpCalendar(ctl,	ctl2, format, OtherFunctions, userleft, usertop) {
		...
		{
			init()
			popUpCalendar(ctl,	ctl2, format, OtherFunctions, userleft, usertop)
		}
	}
