#Region "Purpose"
'*******************************************************************
' Page                   : - Communication setup
' Purpose                : - It will return the mail message
' Date		    		  Author					Modification Date					Description
' 17/05/06				  Jagtar 					06/06/2006        					Created
' Tables used: T010011, EventMaster, EventUserMaster, UDC, T040081, T060011, T070031, T210011, Setup_rules
...
'Session("UNameComn") replace with ViewState("EditComm_UserName")
'Session("RNameComn")replace with ViewState("EditComm_RoleName")
#End Region
...
Partial Class CommunicationSetup_Edit_CommunicationSetup
...
#Region "Page_Load"
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If (Not Page.IsPostBack) Then
            ...
            'PopulateDropDownLists("select ROM_IN4_Role_ID_PK ,ROM_VC50_Role_Name from T070031, T010011 where CI_NU8_Address_Number =* ROM_IN4_Company_ID_FK and ROM_DT8_Start_Date<='" & Now & "' and ROM_DT8_End_Date >='" & Now & "' and ROM_VC50_Status_Code_FK = 'ENB'", ddRoleName, "N")
    ...
    Private Sub Filldata()
        ...
        Try
            ...
            Else
                ...
                rdCallRule = SQL.Search("Editcommsetup", "Filldata-193", "select Mail_on_off, SMS_on_off, Start_Date, Stop_Date,  Event_ID_FK,  Event_User_ID_FK, Event_Fired_ID_FK, user_id, Role_id, Priority, Call_Type, Call_Status, Task_type, Task_Status, Project_ID, Company_id, Rule_Status from Setup_rules where Table_ID =" & intInvid, SQL.CommandBehaviour.Default, blnStatus)
        ...
        Try
            ...
            Else
                ...
                If ddData.ID = "ddUserName" Then
                    ...
                    ViewState.Add("EditComm_UserName", dtDDData)
                ElseIf ddData.ID = "ddRoleName" Then
                    If dtDDData.Rows.Count > 0 Then
                        dtDDData.Rows(0).Delete()
                    End If
                    ''Session.Add("RNameComn", dtDDData)
                    ViewState.Add("EditComm_RoleName", dtDDData)
                End If
...
#Region "EnableDisableDD"
    Private Sub EnableDisableDD()
        ...
        Catch ex As Exception
            CreateLog("RolePermission", "EnableDisableDD-456", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"), "NA")
        End Try
...
#Region "isExisted"
    Private Function isExisted() As Boolean
        ...
        Try
            ...
            QueryString = QueryString & " and record_type='C' and Rule_Status = 1 and Table_ID !=" & intInvid
...
#Region "imgOk_Click"
    Private Sub imgOk_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgOk.Click
        ...
        Try
            ...
            arRowData.Add(Now.ToShortDateString)
            arRowData.Add(GetIP())
            If SQL.Update("Setup_Rules", "Edit_Communicationsetup", "imgok_click", "Select * from Setup_Rules where Table_ID = " & intInvid, arColumnName, arRowData) = True Then
                bln = True
            End If
            If bln = True Then
...
#Region "imgSave_Click"
    Private Sub imgSave_Click(ByVal sender As System.Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgSave.Click
        ...
        Try
            ...
            arRowData.Add(Now.ToShortDateString)
            arRowData.Add(GetIP())
            If SQL.Update("Setup_Rules", "Edit_commsetup", "imgsave_click", "Select * from Setup_Rules where Table_ID = " & intInvid, arColumnName, arRowData) = True Then
                bln = True
            End If
            If bln = True Then
                lstError.Items.Clear()
...
#Region "ddCompany_SelectedIndexChanged"
    Private Sub ddCompany_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddCompany.SelectedIndexChanged
        ...
        dtDDData = ViewState("EditComm_UserName")
        ...
        dtDDData = ViewState("EditComm_RoleName")
