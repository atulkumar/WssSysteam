...
Public Class SecurityPermissionScreens
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "SecurityPermissionScreens.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSecurityPermissionScreens
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SecurityPermissionScreens = New SecurityPermissionScreens
        rpt.Site = Me.Site
        Return rpt
    End Function
