...
Public Class SecurityPermissionsReport
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "SecurityPermissionsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSecurityPermissionsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SecurityPermissionsReport = New SecurityPermissionsReport
        rpt.Site = Me.Site
        Return rpt
    End Function
