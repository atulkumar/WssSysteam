...
Partial Public Class WorkCenter_DoList_ToDoListWeekly
    ...
    Sub fillDefault()
        ...
        Try
            ...
            If blnView = True Then
                ...
                strSelect &= " and Task.TM_NU9_Task_no_PK in (select TaskNo from tblScheduleDetails where Company=TM_NU9_Comp_ID_FK and CallNo=TM_NU9_Call_No_FK and WeekNo=DATEPART( wk, GETDATE()) AND WeekYear=YEAR(GETDATE()))"
