...
Partial Class MonitoringCenter_ObjectEntry
    Inherits System.Web.UI.Page
    Protected WithEvents SaveFastEntry As System.Web.UI.WebControls.Button
...
#Region "Page Load Code"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        txtLimit_F.Attributes.Add("onkeypress", "NumericOnly();")
        ...
        intNext = SQL.Search("ObjectEntry", "Load", "select max(OD_NU9_OID_PK) from T130142")
        intNext = intNext + 1
        ...
        If txthiddenImage <> "" Then
            Try
                Select Case txthiddenImage
                    ...
                    Case "Delete"
                        If SQL.Delete("ObjectEntry", "load", "delete from T130142 where OD_NU9_OID_PK=" & txthiddenValue, SQL.Transaction.Serializable) = True Then
                            lstError.Items.Clear()
                            'cpnlError.Visible = True
                            'cpnlError.Text = "Message"
            ...
            Catch ex As Exception
                CreateLog("ObjectEntry", "Load-236", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
            End Try
        End If
        If mstrqID = "-1" Then
        ...
        If IsPostBack = False Then
            If mstrqID <> "-1" Then
                ...
                Try
                    sqrdr = SQL.Search("ObjEntry", "load", "select * from T130131 where OM_NU9_ID_PK=" & mstrqID, SQL.CommandBehaviour.SingleRow, blnStatus, "")
                    If blnStatus = True Then
                        While sqrdr.Read
                            ...
                            '  If InStr(txtObjectPath.Text, "\") Then
                            Dim pat As String
                            ' Dim gerpath As String

                            'pat = Split(txtObjectPath.Text, "\")
                            ...
                            dtObjectDetail.Text = IIf(Not IsDBNull(sqrdr("OM_DT8_OCreated")), sqrdr("OM_DT8_OCreated"), "")

                            txtDomain.Text = IIf(Not IsDBNull(sqrdr("OM_VC250_DName")), sqrdr("OM_VC250_DName"), "")
                            txtDomainName.Text = SQL.Search("ObjectEntry", "load", "select DM_VC150_DomainName from T170011 where DM_IN4_DID=" & txtDomain.Text.Trim)

                            txtObjectMachineCode.Text = IIf(IsDBNull(sqrdr("OM_IN4_OMID")) = False, sqrdr("OM_IN4_OMID"), "")
                            txtObjectMachineCodeName.Text = SQL.Search("ObjectEntry", "load", "select MM_VC150_Machine_Name from T170012 where MM_VC100_MID=" & txtObjectMachineCode.Text & " and MM_IN4_DID_FK=" & txtDomain.Text.Trim)

                            If Not txtObjectPath.Text = "" Then
                                pat = "\\" + txtObjectMachineCodeName.Text + "\"
                                txtObjectPath.Text = Replace(txtObjectPath.Text, pat, "")
                            End If

                            ' txtObjectMachineCode.Text = IIf(IsDBNull(sqrdr("OM_NU9_OPID")) = False, sqrdr("OM_NU9_OPID"), "")
                            ' txtObjectMachineCodeName.Text = SQL.Search("", "", "select PM_VC20_PName from T130031 where PM_IN4_PCode=" & txtObjectProcessCode.Text)

                        End While
                        sqrdr.Close()
                    End If
                Catch ex As Exception
                    CreateLog("objectEntry", "Load-280", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
                End Try
            End If
        End If
        ...
        If Not IsPostBack Then
            ...
            Try
                ...
                sqrdView = SQL.Search("ObjectEntry", "load", "select UV_VC50_COL_Value,UV_VC50_COL_Name from T030212 where UV_IN4_View_ID=0 and UV_VC50_tbl_Name='T130142' order by uv_in4_id", SQL.CommandBehaviour.CloseConnection, blnView)
                ...
                If blnView = True Then
                    ...
                    strSelect &= " from T130142, T180011 where AM_IN4_AID_FK=OD_IN4_AlertID_FK"
                    srtQueryWhere &= " OD_NU9_OID=" & mstrqID

                    If srtQueryWhere <> "" Then
                        strSelect = strSelect & " and " + srtQueryWhere
                    End If


                    ' SQL.DBTable = "T130142"
                    If SQL.Search("T130142", "ObjectEntry", "load", strSelect, dsDefault, "", "") = True Then
                    ...
                    Else
                        ' Bind the below grid to show header labels for Fast Entry
                        GrdAddSerach.AutoGenerateColumns = True
                        Dim ds As New DataSet
                        ds.Tables.Add("Dummy")

                        ds.Tables("Dummy").Columns.Add("ID")
                        ds.Tables("Dummy").Columns.Add("ODate")
                        ds.Tables("Dummy").Columns.Add("OLimit")
                        ds.Tables("Dummy").Columns.Add("OAlertType")
                        ds.Tables("Dummy").Columns.Add("OMail")
                        ds.Tables("Dummy").Columns.Add("LType")
                        ...
                        arColName.Add("ID")
                        arColName.Add("ODate")
                        arColName.Add("OLimit")
                        arColName.Add("OAlertType")
                        arColName.Add("OMail")
                        arColName.Add("LType")

                        '    FormatGrid(arColName)
                        '    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                ...
                CreateTextBox()
            Catch ex As Exception
                CreateLog("objectEntry", "Load-345", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
            End Try
        Else
            ...
            If txthiddenImage <> "" Then
                Try
                    ...
                    End Select
                Catch ex As Exception
                    CreateLog("ObjectEntry", "Load-367", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
                End Try
            End If

        End If
        If dtObjectDetail_F.Text = "" Then
            dtObjectDetail_F.Text = Today
        End If
...
#Region "fill View"
    ...
    Private Function FillView()
        ...
        Try
            ...
            sqrdView = SQL.Search("ObjectEntry", "FillView", "select UV_VC50_COL_Value,UV_VC50_COL_Name,UV_VC10_Col_Width,UV_NU9_SO,UV_VC5_AD  from T030212 where UV_IN4_View_ID=0 and UV_VC50_tbl_Name='T130142' order by uv_in4_id", SQL.CommandBehaviour.CloseConnection, blnView)
            ...
            If blnView = True Then
                ...
                strSelect &= " and OD_NU9_OID=" & mstrqID
                ' SQL.DBTable = "T130142"

                If SQL.Search("T130142", "ObjectEntry", "FillView", strSelect, dsFromView, "", "") = True Then
            ...
            End If
        Catch ex As Exception
            CreateLog("ObjectEntry", "FillView-477", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try

    End Function

    Private Function FillViewaftersave()
        ...
        Try
            ...
            sqrdView = SQL.Search("ObjectEntry", "Fillviewaftersave", "select UV_VC50_COL_Value,UV_VC50_COL_Name,UV_VC10_Col_Width,UV_NU9_SO,UV_VC5_AD  from T030212 where UV_IN4_View_ID=0 and UV_VC50_tbl_Name='T130142' order by uv_in4_id", SQL.CommandBehaviour.CloseConnection, blnView)
            'If SQL.Search("", "", strConnection, "select name,view_id from tbl_userview_name", dsView, "tbl_userview_detail") = True Then
            If blnView = True Then
                Dim dsFromView As New DataSet
                arColumnName.Clear()
                ...
                If SQL.Search("T130142", "ObjectEntry", "Fillviewaftersave", strSelect, dsFromView, "", "") = True Then
                    ' DataGrid1.DataSource = dsFromView
                    'dsFromView.Tables(0).Columns(0).ColumnName = ""
                    For inti As Integer = 0 To dsFromView.Tables(0).Columns.Count - 1
                        dsFromView.Tables(0).Columns(inti).ColumnName = arColumnName.Item(inti)
...
#Region "Fill data into datagrid and change the header name according the database"
    ...
    Private Sub FillGrid_data()
        ...
        Try
            ...
            'query on database
            sqrdView = SQL.Search("ObjectEntry", "FillGrid_data", "select UV_VC50_COL_Value,UV_VC50_COL_Name from T030212 where UV_IN4_View_ID=0 and UV_VC50_tbl_Name='T130142'", SQL.CommandBehaviour.CloseConnection, blnView)
            ...
            If blnView = True Then
                ...
                If SQL.Search("T130142", "ObjectEntry", "FillGrid_data", strSelect, dsDefault, "", "") = True Then
                    For inti As Integer = 0 To dsDefault.Tables("T130142").Columns.Count - 1
                        dsDefault.Tables("T130142").Columns(inti).ColumnName = arSetColumnName.Item(inti)
                    Next
                End If
            ...
            End If
        Catch ex As Exception
            CreateLog("ObjectEntry", "FillGrid_Data-540", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
    End Sub
...
#Region "fill data into the dropdown from view table "
    ...
    Private Sub GetView()
        ...
        Try
            ...
            sqrdView = SQL.Search("ObjectEntry", "GetView", "select UV_VC50_View_Name, UV_IN4_View_ID from T030201 where  UV_VC50_TBL_Name='T130142'", SQL.CommandBehaviour.CloseConnection, blnView)
            ...
            End If
        Catch ex As Exception
            CreateLog("ObjectEntry", "GetView-567", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
    End Sub
...
#Region "Create textboxes at run time based on datagrid culumns count"
    ...
    Private Function CreateTextBox()
        ...
        Try
            ...
            Next
        Catch ex As Exception
            CreateLog("ObjectEntry", "CreateTextBox-637", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
    End Function
...
#Region "create textbox for User View"
    ...
    Private Function CreateViewTextBox()
        ...
        Try
            ...
            Next
        Catch ex As Exception
            CreateLog("ObjectEntry", "CreateViewTextBox-697", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
    End Function
...
#Region "Format datagrid columns size according to database"
    ...
    Private Sub FormatGrid(ByVal ColumnName As ArrayList)
        ...
        Catch ex As Exception
            CreateLog("ObjectEntry", "FormatGrid-746", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
    End Sub
...
#Region "get columns from database"
    ...
    Private Sub GetColumns()
        ...
        Try
            ...
            sqrdView = SQL.Search("ObjEntry", "GetColums", "select UV_VC50_COL_Value, UV_VC50_COL_Name, UV_VC10_Col_width from T030212 where UV_IN4_View_ID=0 and UV_VC50_tbl_Name='T130142' order by uv_in4_id", SQL.CommandBehaviour.CloseConnection, blnView)
            ...
            sqrdView.Close()
        Catch ex As Exception
            CreateLog("ObjectEntry", "GetColumns-780", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
    End Sub
...
#Region "check the grid width from database"
    ...
    Private Sub chkgridwidth()
        ...
        sqrdView = SQL.Search("ObjectEntry", "chkgridwidth", "select UV_VC50_COL_Value, UV_VC50_COL_Name, UV_VC10_Col_width from T030212 where UV_IN4_View_ID=0 and UV_VC50_tbl_Name='T130142' order by uv_in4_id", SQL.CommandBehaviour.CloseConnection, blnView)
        arColWidth.Clear()
...
#Region "Serach Grid Button Click"
    ...
    Private Sub BtnGrdSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGrdSearch.Click
        ...
        Try
            ...
            GetColumns()
        Catch ex As Exception
            CreateLog("ObjectEntry", "Click-894", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"), "BtnGrdSearch")
        End Try
    End Sub
#End Region
...
#Region "Search Grid Item Data Bound Event"
    ...
    Private Sub GrdAddSerach_ItemDataBound1(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles GrdAddSerach.ItemDataBound
        ...
        Catch ex As Exception
            CreateLog("ObjectEntry", "ItemDataBound-924", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"), "GrdAddSerach")
        End Try
    End Sub
...
#End Region
    ...
    Public Function SaveObjectDetail() As Boolean
        Try
            If ValidateObjectDetailInfo() = True Then
                ...
                arColumnName.Add("OD_IN4_AlertID_FK")
                arColumnName.Add("OD_VC75_OMail")
                arColumnName.Add("OD_CH2_Status")
                arColumnName.Add("OD_CH1_LimitType")
                arColumnName.Add("OD_VC150_DName")
                arColumnName.Add("OD_VC150_MName")


                'Dim ss As String = Request.Form("txtHidden")
                'Dim ss1 As String = Request.Form("txtHiddenImage")


                arRowData.Add(txtOIDPK_F.Text.Trim)
                arRowData.Add(txtObjectID.Text.Trim)
                arRowData.Add(dtObjectDetail_F.Text.Trim)
                arRowData.Add(txtLimit_F.Text.Trim)
                arRowData.Add(txtAlertType_F.Text.Trim)
                arRowData.Add(txtMail_F.Text.Trim)
                arRowData.Add("C")
                arRowData.Add(rblType.SelectedValue)
                arRowData.Add(txtDomainName.Text.Trim)
                arRowData.Add(txtObjectMachineCode.Text.Trim)



                If SQL.Save("T130142", "ObjectEntry", "SaveObjectDetail", arColumnName, arRowData) = True Then
                    ...
                    If IsNothing(strOID) = False Then
                        If SQL.Update("ObjectEntry", "SaveObjectDetail-986", "update T130131 set OM_CH2_Status='C' where OM_NU9_ID_PK=" & txtObjectID.Text.Trim & "", SQL.Transaction.Serializable) = True Then
            ...
            End If
        Catch ex As Exception
            CreateLog("ObjectEntry", "SaveObjectDetail-988", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.ToString, Session("PropUserID"), Session("PropUserName"))
        End Try
    End Function
    ...
    Public Function SaveObject() As Boolean
        ...
        Try
            If ValidateObjectInfo() = True Then
                ...
                If mstrqID = "-1" Or mstrqID = Nothing Then

                    Dim intObjectID As Integer = SQL.Search("ObjectEntry", "SaveObject", "select max(OM_NU9_ID_PK) from T130131")
                    intObjectID += 1
                    txtObjectID.Text = intObjectID
                    dtObjectDetail.Text = Today
                ...
                arColumnName.Add("OM_VC250_DName")
                arColumnName.Add("OM_IN4_OMID")
                ...
                If getMachType(txtObjectMachineCode.Text.Trim, txtDomain.Text.Trim) Then
                    arRowData.Add(txtObjectPath.Text.Trim)
                ElseIf txtObjectTypeName.Text.Trim.ToUpper.Equals("DISK") Then
                    arRowData.Add(txtObjectPath.Text.Trim)
                Else
                    arRowData.Add("\\" + txtObjectMachineCodeName.Text.Trim + "\" + txtObjectPath.Text.Trim)
                End If

                arRowData.Add(dtObjectDetail.Text.Trim)
                arRowData.Add("99")
                arRowData.Add("10020012")
                arRowData.Add(txtDomain.Text.Trim)
                arRowData.Add(txtObjectMachineCode.Text.Trim)



                If mstrqID = "-1" Or mstrqID = Nothing Then
                    If SQL.Save("T130131", "ObjectEntry", "SaveObject", arColumnName, arRowData) = True Then
                        SaveDBInfo()
                ...
                Else
                    ...
                    If SQL.Update("ObjectEntry", "ObjectEntry", "SaveObject", "select * from T130131 where OM_NU9_ID_PK=" & mstrqID, arColumnName, arRowData) = True Then
                        mstrqID = txtObjectID.Text.Trim
                        lstError.Items.Clear()
                        ' cpnlError.Visible = True
                        cpnlError.Text = "Message"
                    ...
                    Else
                        lstError.Items.Clear()
                        lstError.Items.Add("Server is busy plaese try later...")
                        ShowMsgPenel(cpnlError, lstError, ImgError, mdlMain.MSG.msgError)
                        'cpnlError.Visible = True
                        'cpnlError.Text = "Error Message"
                        'ImgError.ImageUrl = "../images/error_image.gif"
        ...
        Catch ex As Exception
            ...
            'MessagePanelListStyle(lstError, mdlMain.MSG.msgError)
            ShowMsgPenel(cpnlError, lstError, ImgError, mdlMain.MSG.msgError)
            CreateLog("ObjectEntry", "SaveObject-1315", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.ToString, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
            Return False
        End Try

    End Function
    Function getMachType(ByVal machinid As String, ByVal domianID As String) As String
        ...
        Try
            Dim strCheck As String = SQL.Search("T170012", "ObjectEntry", "getMachType", "select MM_VC8_Machine_Type from T170012 where MM_IN4_DID_FK=" & domianID & " and MM_VC100_MID =" & machinid & "", dsAtt, "", "")

            If dsAtt.Tables("T170012").Rows(0).Item(0) = "S" Then
                Return True
            Else
                Return False
            End If
        Catch ex As Exception
            CreateLog("ODJEntry", "getMachType-988", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.ToString, Session("PropUserID"), Session("PropUserName"))
            Return False
        End Try
    ...
    Public Function CheckObjectDetail() As Boolean
        If txtAlertType_F.Text = "" And txtLimit_F.Text = "" And txtMail_F.Text = "" Then
            Return False
        Else
            Return True
        End If
    ...
    Public Function ValidateObjectDetailInfo() As Boolean
        ...
        Try
            ...
            If SQL.Search("ObjectEntry", "ValidateObjectDetailInfo", "select  OD_NU9_OID_PK from T130142 where OD_NU9_OID_PK=" & txtOIDPK_F.Text, intRows) = True Then
        ...
        Catch ex As Exception
            ...
            'ImgError.ImageUrl = "../images/error_image.gif"
            'MessagePanelListStyle(lstError, mdlMain.MSG.msgError)
            CreateLog("ObjectEntry", "ValidateObjectDeatilInfo-1145", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
            Return False
        End Try
    ...
    Public Function ValidateObjectInfo() As Boolean
        ...
        If dtObjectDetail.Text.Equals("") Then
            shFlag = 1
        ...
        Catch ex As Exception
            ...
            'MessagePanelListStyle(lstError, mdlMain.MSG.msgError)
            ShowMsgPenel(cpnlError, lstError, ImgError, mdlMain.MSG.msgError)
            CreateLog("ObjectEntry", "ValidateObjectDetailInfo-1218", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
            Return False
        End Try
        Return True
    End Function
    ...
    Private Function SaveDBInfo() As Boolean
        Try
            ...
            strPEnv = SQL.Search("ObjectEntry", "SaveDBInfo", "select PM_VC20_PENV from T130031 where PM_VC20_PName='OBJINFO'")
            Dim sqRdr As SqlClient.SqlDataReader
            Dim blnStatus As Boolean
            sqRdr = SQL.Search("ObjectEntry", "SaveDBInfo", "select * from T130172 where EV_VC30_Environment_Name='" & strPEnv & "'", SQL.CommandBehaviour.SingleRow, blnStatus)
            Dim arColumnName As New ArrayList
            Dim arRowData As New ArrayList
            SQL.DBConnection = System.Configuration.ConfigurationManager.ConnectionStrings("ConnectionString").ToString
            'SQL.DBTable = "T130153"
            ...
            End While
            sqRdr.Close()
            If SQL.Save("T130153", "ObjectEntry", "SaveDBInfo", arColumnName, arRowData) = True Then
                Return True
            Else
                Return False
            End If
        Catch ex As Exception
            CreateLog("ObjectEntry", "SaveDBInfo-1263", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
    End Function
End Class
