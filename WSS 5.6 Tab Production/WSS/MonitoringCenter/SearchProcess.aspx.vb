...
Partial Class MonitoringCenter_SearchProcess
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If txthiddenImage <> "" Then
            Try
                Select Case txthiddenImage
                    ...
                    Case "Add"
                        Response.Redirect("ProcessEntry.aspx?ID=-1")
                    Case "Delete"
                        If SQL.Delete("SearchProcess", "Load", "delete from T130031 where PM_IN4_PCode=" & txthiddenValue, SQL.Transaction.Serializable) = True Then
            ...
            Catch ex As Exception
                ...
                CreateLog("SearchProcess", "Load-174", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
            End Try
        End If
        ...
        If Not IsPostBack Then
            ...
            Try
                ...
                sqrdView = SQL.Search("SearchProcess", "Load", "select UV_VC50_COL_Value,UV_VC50_COL_Name from T030212 where UV_IN4_View_ID=0 and UV_VC50_tbl_Name='T130031' order by uv_in4_id", SQL.CommandBehaviour.CloseConnection, blnView)
                ...
                If blnView = True Then
                    ...
                    End If
                    'SQL.DBTable = "T130031"
                    If SQL.Search("T130031", "SearchProcess", "Load", strSelect, dsDefault, "", "") = True Then
                ...
                CreateTextBox()
            Catch ex As Exception
                CreateLog("SearchProcess", "Load-239", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"), "NA")
            End Try
        Else
            ...
            If txthiddenImage <> "" Then
                Try
                    ...
                    End Select
                Catch ex As Exception
                    CreateLog("SearchProcess", "Load-262", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"), "NA")
                End Try
            End If
...
#Region "fill View"
    ...
    Private Function FillView()
        ...
        Try
            ...
            sqrdView = SQL.Search("SearchProcess", "FillView", "select UV_VC50_COL_Value,UV_VC50_COL_Name,UV_VC10_Col_Width,UV_NU9_SO,UV_VC5_AD  from T030212 where UV_IN4_View_ID=0 and UV_VC50_tbl_Name='T130031' order by uv_in4_id", SQL.CommandBehaviour.CloseConnection, blnView)
            ...
            If blnView = True Then
                ...
                If SQL.Search("T130031", "", "", strSelect, dsFromView, "", "") = True Then
            ...
            End If
        Catch ex As Exception
            CreateLog("SearchProcess", "FillView-371", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
...
#Region "Fill data into datagrid and change the header name according the database"
    ...
    Private Sub FillGrid_data()
        ...
        Try
            ...
            'query on database
            sqrdView = SQL.Search("SearchProcess", "FillGrid_data", "select UV_VC50_COL_Value,UV_VC50_COL_Name from T030212 where UV_IN4_View_ID=0 and UV_VC50_tbl_Name='T130031'", SQL.CommandBehaviour.CloseConnection, blnView)
            ...
            If blnView = True Then
                ...
                If SQL.Search("T130031", "SearchProcess", "FillGrid_data", strSelect, dsDefault, "", "") = True Then
                    For inti As Integer = 0 To dsDefault.Tables("T130031").Columns.Count - 1
                        dsDefault.Tables("T130031").Columns(inti).ColumnName = arSetColumnName.Item(inti)
                    Next
                End If
            ...
            End If
        Catch ex As Exception
            CreateLog("SearchProcess", "FillGrid_Data-435", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
    End Sub
...
#Region "fill data into the dropdown from view table "
    ...
    Private Sub GetView()
        ...
        Try
            ...
            sqrdView = SQL.Search("SearchProcess", "GetView", "select UV_VC50_View_Name, UV_IN4_View_ID from T030201 where  UV_VC50_TBL_Name='T130031'", SQL.CommandBehaviour.CloseConnection, blnView)
            ...
            End If
        Catch ex As Exception
            CreateLog("SearchProcess", "GetView-463", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
    End Sub
...
#Region "Create textboxes at run time based on datagrid culumns count"
    ...
    Private Function CreateTextBox()
        ...
        Try
            ...
            Next
        Catch ex As Exception
            CreateLog("SearchProcess", "CreateTextBox-532", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
    End Function
...
#Region "create textbox for User View"
    ...
    Private Function CreateViewTextBox()
        ...
        Try
            ...
            Next
        Catch ex As Exception
            CreateLog("SearchProcess", "CreateViewTextBox-592", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
    End Function
...
#Region "Format datagrid columns size according to database"
    ...
    Private Sub FormatGrid(ByVal ColumnName As ArrayList)
        ...
        Catch ex As Exception
            CreateLog("SearchProcess", "FormatGrid-639", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
    End Sub
...
#Region "get columns from database"
    ...
    Private Sub GetColumns()
        ...
        Try
            ...
            sqrdView.Close()
        Catch ex As Exception
            CreateLog("SearchProcess", "GetColumns-673", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
    End Sub
...
#Region "check the grid width from database"
    ...
    Private Sub chkgridwidth()
        ...
        sqrdView = SQL.Search("SearchProcess", "chkgridwidth", "select UV_VC50_COL_Value, UV_VC50_COL_Name, UV_VC10_Col_width from T030212 where UV_IN4_View_ID=0 and UV_VC50_tbl_Name='T130031' order by uv_in4_id", SQL.CommandBehaviour.CloseConnection, blnView)
        arColWidth.Clear()
...
#Region "Serach Grid Button Click"
    ...
    Private Sub BtnGrdSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGrdSearch.Click
        ...
        Try
            ...
            GetColumns()
        Catch ex As Exception
            CreateLog("SearchProcess", "Click-773", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"), "BtnGrdAddSearch")
        End Try
    End Sub
#End Region
...
#Region "Search Grid Item Data Bound Event"
    ...
    Private Sub GrdAddSerach_ItemDataBound1(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles GrdAddSerach.ItemDataBound
        ...
        Catch ex As Exception
            CreateLog("SearchProcess", "ItemDataBound-720", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.Message, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"), "GrdAddSerach")
        End Try
    End Sub
