...
Partial Class MonitoringCenter_AlertFlow
...
#Region "Page Load Code"
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        arOriginalColumnName.Add("AF_NU9_AID")
        arOriginalColumnName.Add("AF_NU9_LNID")
        arOriginalColumnName.Add("AF_VC8_Type")
        arOriginalColumnName.Add("AF_VC50_COM")
        arOriginalColumnName.Add("AF_NU9_ABNUM")
        arOriginalColumnName.Add("AF_VC8_Status")

        arSetColumnName.Clear()
        arSetColumnName.Add("AlertID")
        arSetColumnName.Add("LineID")
        arSetColumnName.Add("Type")
        arSetColumnName.Add("CommMode")
        arSetColumnName.Add("AddressBookNumber")
        arSetColumnName.Add("Status")

        arColumnName.Clear()
        arColumnName.Add("AlertID")
        arColumnName.Add("LineID")
        arColumnName.Add("Type")
        arColumnName.Add("CommMode")
        arColumnName.Add("AddressBookNumber")
        ...
        If Not IsPostBack Then
            ...
            Try
                ...
                strSelect &= " from T180012"
                If srtQueryWhere <> "" Then
                    strSelect = strSelect & " where " + srtQueryWhere
                End If
                ' SQL.DBTable = "T180012"
                If SQL.Search("T180012", "AlertFlow", "Load", strSelect, dsDefault, "", "") = True Then

                    'change the datagrid header columns name 
                    For inti As Integer = 0 To dsDefault.Tables("T180012").Columns.Count - 1
                        dsDefault.Tables("T180012").Columns(inti).ColumnName = arSetColumnName.Item(inti)
                    Next
                End If
                mdvtable.Table = dsDefault.Tables("T180012")
                'End If
                '**************
                ...
                CreateTextBox()
            Catch ex As Exception
                CreateLog("AlertFlow", "Load-219", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.ToString, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
            End Try
        Else
            ...
            If txthiddenImage <> "" Then
                Try
                    ...
                    End Select
                Catch ex As Exception
                    CreateLog("AlertFlow", "Load-242", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.ToString, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
                End Try
            End If
...
#Region "fill View"
    ...
    Private Function FillView()
        ...
        Try
            ...
            If SQL.Search("T180012", "AlertFlow", "FillView", strSelect, dsFromView, "", "") = True Then
            ...
            'End If
        Catch ex As Exception
            CreateLog("AlertFlow", "Fillview-351", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.ToString, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
...
#Region "Create textboxes at run time based on datagrid culumns count"
    ...
    Private Function CreateTextBox()
        ...
        Try
            ...
            Next
        Catch ex As Exception
            CreateLog("AlertFlow", "CreateTextBox-516", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.ToString, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
    End Function
...
#Region "Format datagrid columns size according to database"
    ...
    Private Sub FormatGrid(ByVal ColumnName As ArrayList)
        ...
        Catch ex As Exception
            CreateLog("AlertFlow", "FormatGrid-623", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.ToString, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"))
        End Try
    End Sub
...
#Region "Serach Grid Button Click"
    ...
    Private Sub BtnGrdSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGrdSearch.Click
        ...
        Try
            ...
            FormatGrid(arColumnName)
        Catch ex As Exception
            CreateLog("AlertFlow", "BtnGrdSearch_Click-757", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.ToString, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"), "BtnGrdSearch")
        End Try
    End Sub
#End Region
...
#Region "Search Grid Item Data Bound Event"
    ...
    Private Sub GrdAddSerach_ItemDataBound1(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.DataGridItemEventArgs) Handles GrdAddSerach.ItemDataBound
        ...
        Catch ex As Exception
            CreateLog("AlertFlow", "GrdAddSearch_ItemDataBound-787", LogType.Application, LogSubType.Exception, ex.TargetSite.Attributes, ex.ToString, HttpContext.Current.Session("PropUserID"), HttpContext.Current.Session("PropUserName"), "GrdAddSearch")
        End Try
    End Sub
...
#End Region
    ...
    Private Function DeleteAlert() As Boolean
        ...
        Try
            ...
            If SQL.Delete("AlertFlow", "DeleteAlert", "delete from T180012 where AM_IN4_AID_FK=" & intAlertID, SQL.Transaction.Serializable) = True Then
                'cpnlError.Visible = True
