			...
			;
                ...
                if (o.closable) {
					...
					.click(function(evt) {
					    ...
					    //Modified By Atul(Custom Code for Pin image)
					    var tblRole1 = document.getElementById("tblRole");
					    if (document.getElementById("imgSideClose").style.display == "none")
					        tblRole1.style.display = "block";
					    else if (document.getElementById("imgSideOk").style.display == "none") {
					        tblRole1.style.display = "none";
					    }

					    if (document.getElementById("tblRole").style.display == "block") {
					        if (document.getElementById("imgSideClose") != null)
					            document.getElementById("imgSideClose").style.display = "block";
					        if (document.getElementById("imgSideOk") != null)
					            document.getElementById("imgSideOk").style.display = "none";
					    }
					    else {
					        if (document.getElementById("imgSideClose") != null)
					    ...
					    toggle(pane); evt.stopPropagation();
					})
