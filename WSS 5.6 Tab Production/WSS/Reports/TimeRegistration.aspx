<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TimeRegistration.aspx.vb"
    Inherits="Reports_TimeRegistration" MaintainScrollPositionOnPostback="true" %>
                                            ...
                                            <tr>
                                                <td valign="top" align="left" colspan="1" rowspan="1">
                                                    ...
                                                    <cc1:CollapsiblePanel ID="cpnlRS" runat="server" BorderWidth="0px" BorderStyle="Solid"
                                                        Width="100%" Height="40px" TitleCSS="test" PanelCSS="panel" TitleForeColor="black"
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Label ID="lblCompany" Font-Size="XX-Small" Font-Names="Verdana" Font-Bold="True"
                                                                        Width="72px" Height="12px" runat="server"> Company</asp:Label>
                                                                </td>
                                                                <td>
