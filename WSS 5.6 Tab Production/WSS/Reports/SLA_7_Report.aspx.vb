...
Partial Class Reports_SLA_7_Report
...
#End Region
    ...
    Private Sub bindGrid()
        Try
            ...
            'strSqlQuery = "select CM_NU9_Call_No_PK ,CM_VC100_Subject as [Call Subject],CM_VC200_Work_Priority as [Priority],CM_DT8_Request_Date as [Registered Date],(select min(Comment.CM_DT8_Date)  from T040061 Comment where  Comment.cm_nu9_call_number = a.CM_NU9_Call_No_PK and cm_nu9_compID_fk=38 and cm_nu9_ab_number= 104)as [Comment Date],datediff(minute,CM_DT8_Request_Date,(select min(Comment.CM_DT8_Date)  from T040061 Comment where  Comment.cm_nu9_call_number = a.CM_NU9_Call_No_PK and cm_nu9_compID_fk=38 and cm_nu9_ab_number= 104 and a.CM_VC200_Work_Priority=1))as [Difference In minutes], (case when convert(varchar,CM_DT8_Request_Date,8)  between convert(datetime,'08:00',8) and convert(datetime,'18:00:00',8) then 'Yes' else 'No' end) as [Business Hours]  from T040011 a where (CONVERT(datetime, CM_DT8_Request_Date) >= '" & dtFromDate.Text & "') and (CONVERT(datetime, CM_DT8_Request_Date) <='" & dtToDate.Text & "') and CM_VC200_Work_Priority=1 and CM_NU9_Comp_Id_FK=38"
            ' strSqlQuery = "select CM_NU9_Call_No_PK ,CM_VC100_Subject as [Call Subject],CM_VC200_Work_Priority as [Priority],CM_DT8_Request_Date as [Registered Date],(select min(Comment.CM_DT8_Date)  from T040061 Comment where  Comment.cm_nu9_call_number = a.CM_NU9_Call_No_PK and cm_nu9_compID_fk=38 and cm_nu9_ab_number= 104)as [Comment Date],datediff(minute,CM_DT8_Request_Date,(select min(Comment.CM_DT8_Date)  from T040061 Comment where  Comment.cm_nu9_call_number = a.CM_NU9_Call_No_PK and cm_nu9_compID_fk=38 and cm_nu9_ab_number= 104 and a.CM_VC200_Work_Priority<>1))as [Difference In minutes], (case when convert(varchar,CM_DT8_Request_Date,8)  between convert(datetime,'08:00',8) and convert(datetime,'18:00:00',8) then 'Yes' else 'No' end) as [Business Hours]  from T040011 a where (CONVERT(datetime, CM_DT8_Request_Date) >= '" & dtFromDate.Text & "') and (CONVERT(datetime, CM_DT8_Request_Date) <='" & dtToDate.Text & "') and CM_VC200_Work_Priority<>1 and CM_NU9_Comp_Id_FK=38"
            'strSqlQuery = "select CM_NU9_Call_No_PK ,CM_VC100_Subject as [Call Subject],CM_VC200_Work_Priority as [Priority],CM_DT8_Request_Date as [Registered Date],(select min(Task.TM_DT8_Task_Date)  from T040021 Task where  Task.TM_NU9_Call_No_FK = a.CM_NU9_Call_No_PK and TM_NU9_Comp_ID_FK=38 and Task.TM_NU9_Assign_by= 104)as [Task Entered Date],datediff(minute,(select min(Task.TM_DT8_Task_Date)  from T040021 Task where  Task.TM_NU9_Call_No_FK   = a.CM_NU9_Call_No_PK and TM_NU9_Comp_ID_FK=38 and TM_NU9_Assign_by= 104 and a.CM_VC200_Work_Priority<>1),CM_DT8_Request_Date) as [Difference In minutes], (case when convert(varchar,CM_DT8_Request_Date,8)  between convert(datetime,'08:00',8) and convert(datetime,'18:00:00',8) then 'Yes' else 'No' end) as [Business Hours]  from T040011 a where (CONVERT(datetime, CM_DT8_Request_Date) >= '" & dtFromDate.Text & "') and (CONVERT(datetime, CM_DT8_Request_Date) <='" & dtToDate.Text & "') and CM_VC200_Work_Priority<>1 and CM_NU9_Comp_Id_FK=38"
            'strSqlQuery = "select CM_NU9_Call_No_PK ,CM_VC100_Subject as [Call Subject],CM_VC200_Work_Priority as [Priority],CM_DT8_Request_Date as [Registered Date],(select   min(Task.TM_DT8_Task_Date)   from T040021 Task where  Task.TM_NU9_Call_No_FK = a.CM_NU9_Call_No_PK and TM_NU9_Comp_ID_FK=38 and Task.TM_NU9_Assign_by= 104)as [Task Entered Date],datediff(minute,CM_DT8_Request_Date,(select  min(Task.TM_DT8_Task_Date)   from T040021 Task where  Task.TM_NU9_Call_No_FK   = a.CM_NU9_Call_No_PK and TM_NU9_Comp_ID_FK=38 and TM_NU9_Assign_by= 104 and a.CM_VC200_Work_Priority<>1)) as [Difference In minutes], (case when convert(varchar,CM_DT8_Request_Date,8) between convert(datetime,'08:00',8) and convert(datetime,'18:00:00',8) then 'Yes' else 'No' end) as [Business Hours]  from T040011 a where (CONVERT(datetime, CM_DT8_Request_Date) >= '" & dtFromDate.Text & "') and (CONVERT(datetime, CM_DT8_Request_Date) <='" & dtToDate.Text & "')and CM_VC200_Work_Priority<>1 and CM_NU9_Comp_Id_FK=38 and CM_NU9_Call_No_PK=(select   TM_NU9_Call_No_FK   from T040021 Task where  Task.TM_NU9_Call_No_FK = a.CM_NU9_Call_No_PK and TM_NU9_Comp_ID_FK=38 and Task.TM_NU9_Assign_by= 104)"
            strSqlQuery = "select CM_NU9_Call_No_PK ,CM_VC100_Subject as [Call Subject],CM_VC200_Work_Priority as [Priority],CM_DT8_Request_Date as [Registered Date],(select   min(Task.TM_DT8_Task_Date)   from T040021 Task where  Task.TM_NU9_Call_No_FK = a.CM_NU9_Call_No_PK and TM_NU9_Comp_ID_FK=38 and Task.TM_NU9_Assign_by= 104)as [Task Entered Date],datediff(minute,CM_DT8_Request_Date,(select min(Task.TM_DT8_Task_Date)   from T040021 Task where  Task.TM_NU9_Call_No_FK   = a.CM_NU9_Call_No_PK and TM_NU9_Comp_ID_FK=38 and TM_NU9_Assign_by= 104 and CM_VC100_By_Whom <> '104' and a.CM_VC200_Work_Priority<>1)) as [Difference In minutes], (case when convert(varchar,CM_DT8_Request_Date,8) between convert(datetime,'08:00',8) and convert(datetime,'18:00:00',8) then 'Yes' else 'No' end) as [Business Hours]  from T040011 a where convert(datetime,CONVERT(varchar, CM_DT8_Request_Date,101)) >= '" & dtFromDate.Text & "' and convert(datetime,CONVERT(varchar, CM_DT8_Request_Date,101)) <='" & dtToDate.Text & "' and CM_VC200_Work_Priority<>1 and CM_NU9_Comp_Id_FK=38 and CM_VC100_By_Whom <> '104' and CM_NU9_Call_No_PK in (select   TM_NU9_Call_No_FK   from T040021 Task where  Task.TM_NU9_Call_No_FK = a.CM_NU9_Call_No_PK and TM_NU9_Comp_ID_FK=38 and Task.TM_NU9_Assign_by= 104)"
