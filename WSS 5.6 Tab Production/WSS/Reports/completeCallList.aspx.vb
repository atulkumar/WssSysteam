...
Partial Class Reports_completeCallList
...
#End Region
    ...
    Private Sub bindGrid()
        Try
            ...
            strSqlQuery &= "and CM_NU9_Call_No_PK in (select CM_NU9_Call_No_PK from T040011 where T040011.CN_VC20_Call_Status='" & ddlStatus.SelectedItem.Text & "')"
            strSqlQuery &= " and CM_NU9_Comp_Id_FK in (" & GetCompanySubQuery() & ")  "
