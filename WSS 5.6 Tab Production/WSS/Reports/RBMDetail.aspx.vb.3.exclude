...
#Region "ShowReport"
    ...
    Private Sub ShowReport()
        Try
            ...
            If Not ddlEmp.SelectedValue = 0 Then
                dtRBMPaid = GetFilteredDataView(dtRBMPaid.DefaultView, "CI_NU8_Address_Number='" & ddlEmp.SelectedValue & "'").Table
            End If
